...
function TopicsHub() {
  usePageSeo({
    ...
    description:
      'Explore curated topic hubs for business, world, Thailand, and culture coverage with fast internal navigation.',
    ...
    <article className='max-w-6xl mx-auto px-4 sm:px-6 py-8 text-white'>
      ...
      <section className='surface-panel p-5 sm:p-6 md:p-8'>
        <p className='text-white/90 max-w-3xl'>
          Choose a high-signal topic hub to jump into focused coverage with clear next
          actions and source-backed stories.
        </p>
